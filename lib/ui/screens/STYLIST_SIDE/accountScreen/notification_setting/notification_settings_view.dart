...
import 'package:styld_stylist/ui/screens/STYLIST_SIDE/accountScreen/notification_setting/notification_setting_view_model.dart';
...
class _NotificationSettingsViewState extends State<NotificationSettingsView> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => NotificationSettingViewModel(),
      child: Consumer<NotificationSettingViewModel>(
