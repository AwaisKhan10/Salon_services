...
import 'package:styld_stylist/ui/screens/CUSTOMER_SIDE/customer_account/notification_setting/notification_view_model.dart';
import 'package:modal_progress_hud_nsn/modal_progress_hud_nsn.dart';

class CustomerAllNotificationsScreen extends StatelessWidget {
  CustomerAllNotificationsScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<NotificationViewModel>(builder: (context, model, child) {
