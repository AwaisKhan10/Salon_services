...
class ScheduleOrderTile extends StatelessWidget {
  final bool? isUpcoming;
  // final ScheduleOrderModel scheduleOrder;
  final Booking booking;
  final VoidCallback? onPressAction;
  const ScheduleOrderTile({
    Key? key,
              ...
              Row(
                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage:
                        NetworkImage(booking.stylistUser!.imgUrl!),
                  ),
                  SizedBox(width: 10.w),
                  Flexible(
                    child: Column(
                  ...
                  Flexible(
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset(StyldImages.smMapIcon),
                          SizedBox(
                            width: 10.w,
                          ),
                          Text("View On Map",
