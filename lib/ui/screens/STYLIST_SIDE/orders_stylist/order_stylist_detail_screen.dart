...
class OrderStylistDetailScreen extends StatelessWidget {
  const OrderStylistDetailScreen({Key? key, required this.scheduleOrderModel})
      : super(key: key);
                      ...
                      child: Column(
                        children: [
                          ...
                          CircleImagePlaceholder(
                            radius: 40,
                            backgroundImage:
                                AssetImage(scheduleOrderModel.path),
                          ),
                          SizedBox(
                            height: 5.h,
                          ),
